...
export default function CoffeeRoute() {
  ...
  return (
    <div className="min-h-screen bg-[#010101] text-white">
      {/* ================= NAVBAR ================= */}
      <nav className="fixed top-0 right-0 left-0 z-50 flex items-center justify-between border-b border-[#513c28] bg-black/80 px-[7%] py-5 backdrop-blur-sm">
        {/* Logo */}
        <a href="#home" className="text-3xl font-bold italic text-white">
          kenangan
          <span className="text-[#b6895b]">senja</span>.
        </a>
        ...
        >
          <a
            ...
            className="block px-6 py-4 text-2xl text-black md:inline-block md:px-4 md:py-0 md:text-lg md:text-white"
          >
            Home
          </a>
      ...
      >
        {/* Gradient */}
        <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#010101] to-transparent" />
